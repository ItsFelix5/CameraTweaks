...
Fullbright can be toggled by pressing <kbd>Y</kbd>

## 🎦 Freecam
With freecam you can easily fly around just like spectator, this is very useful for building or exploring.

You can toggle freecam by pressing <kbd>H</kbd>, scroll to change speed and <kbd>J</kbd> to toggle player movement.

You can also remember up to 9 positions by pressing <kbd>J</kbd> + any hotbar slot and teleport back by pressing <kbd>H</kbd> + that hotbar slot.
## 🔎 Zoom
...
Press <kbd>C</kbd> to zoom and scroll to change how much.
...
Yes, of course as long as it stays on Modrinth! (or Curseforge ew)
